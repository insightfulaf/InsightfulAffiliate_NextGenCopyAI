## Notes
This tracker is split by brand to prevent mixing images or manifests between InsightfulAffiliate and NextGenCopyAI. Use the URLs below when filling in the head snippet for each site.

## Brand Profiles

### Shared
- CSS (canonical):
  - ngcai.css → https://d1yei2z3i6k35z.cloudfront.net/13254463/68f2fb38333dd_ngcai.css
  - Tip: If a site needs small visual differences, add a tiny brand override CSS and load it after ngcai.css.

### InsightfulAffiliate
- Manifest: UPLOAD to IA workspace and paste URL here → <ADD_URL>
- OG/Twitter (choose light or dark to match page art):
  - OG: https://d1yei2z3i6k35z.cloudfront.net/13254463/68c25df1dc6f4_InsightfulAffiliate_og_light_1200x630.png
  - Twitter: https://d1yei2z3i6k35z.cloudfront.net/13254463/68c25df1dd6c4_InsightfulAffiliate_twitter_light_1200x628.png
...
### NextGenCopyAI
- Manifest: UPLOAD to NGC workspace and paste URL here → <ADD_URL>
- OG/Twitter (current defaults):
  - OG (dark): https://d1yei2z3i6k35z.cloudfront.net/13254463/68ce610b1fb2d_og-default.png
  - Twitter (dark): https://d1yei2z3i6k35z.cloudfront.net/13254463/68ce61326564f_twitter-default.png
...
## Usage (keep brands separate)
- When creating a head snippet for InsightfulAffiliate pages, use the InsightfulAffiliate OG/Twitter images and the IA manifest URL. Do not mix with NGC defaults.
- For NextGenCopyAI pages, use the NGC OG/Twitter images and the NGC manifest URL.
- Both sites can load the same canonical CSS (ngcai.css). If small visual differences are desirable, load a small brand override CSS after ngcai.css.
